...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_KB] = LAYOUT(
	  ...
	  KC_LGUI, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_LBRC,     KC_RBRC, KC_N, KC_M, KC_COMM, KC_DOT, RCAG_T(KC_SLSH), MT(MOD_LGUI,KC_BSLS),
	  KC_LALT, KC_LCTL, LT(_UTIL,KC_ESC), KC_SPC,         KC_BSPC, LT(_KEYPAD,KC_ENT), KC_DEL, LT(_SYSTEM,KC_NO)
	),
	[_UTIL] = LAYOUT(
	  ...
	  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                               KC_DEL, KC_ENT, KC_TRNS, KC_PRINT_SCREEN
	),
	[_KEYPAD] = LAYOUT(
	...
	[_SYSTEM] = LAYOUT(
	   ...
	   CG_TOGG, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, CG_SWAP, CG_NORM, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
	   KC_TRNS, KC_TRNS, KC_TRNS, CG_TOGG, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
	),
};
